    ...
    while True:
        ...
        if right == "" and left == "":
            ...
            if x < 200:
                ...
                x = 300
                right, left = "", ""
                cv2.imwrite(f'visitors/in/{datetime.now().strftime("%H-%M-%S")}.jpg', frm1)
                cv2.putText(frame1, "IN", (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 2)
            ...
            if x > 500:
                ...
                x = 300
                right, left = "", ""
                cv2.imwrite(f'visitors/out/{datetime.now().strftime("%H-%M-%S")}.jpg', frm1)
                cv2.putText(frame1, "OUT", (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 2)
