...
btn7_image = Image.open('icons/cctv.png')
...
btn1 = tk.Button(frame1, text='Smart CC', height=90, width=180, fg='green',command = find_motion, image=btn1_image, compound='left')
btn1['font'] = btn_font
...
btn5 = tk.Button(frame1,text="Exit",height=90, width=180, fg='orange', command=window.quit, image=btn5_image,compound="left")
btn5['font'] = btn_font
btn5.grid(row=5, pady=(20,10), column=3)
#
btn7 = tk.Button(frame1, text="Monitor", fg="orange",command=ident , compound='left', image=btn7_image, height=90, width=180)
btn7['font'] = btn_font
btn7.grid(row=5, pady=(20,10))
